...
<body >
    <div class="container">
            <div class="login-content">
                ...
                @endif
                <h4 class="text-center">Football Club Registration</h4>
                    <form action="{{ route('club.login.submit') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group"> 
                                    <label for="telephone" class=" form-control-label">Phone</label>
