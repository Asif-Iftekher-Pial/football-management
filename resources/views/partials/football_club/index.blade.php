                                                        ...
                                                        <td>
                                                            <div>
                                                                @if ($football_club->payment == 'not_paid')
                                                                    <a href="{{ route('sendPaypalPaymentLink', $football_club->user->id) }}"
                                                                ...
                                                                <div class="row">
                                                                    <div class="dropdown">
                                                                        <button
                                                                            class="btn btn-sm {{ $football_club->payment == 'paid' ? 'btn-success' : 'btn-danger' }} dropdown-toggle"
                                                                            type="button" id="dropdownMenuButton"
                                                                            data-toggle="dropdown" aria-haspopup="true"
                                                                            aria-expanded="false">
                                                                            {{ ucwords(str_replace('_', ' ', $football_club->payment)) }}
                                                                        </button>
                                                                        <div class="dropdown-menu"
                                                                            aria-labelledby="dropdownMenuButton">
                                                                            <a class="dropdown-item"
                                                                                href="{{ route('football_club.payment.status', ['id' => $football_club->id, 'status' => 'paid']) }}">Paid</a>
                                                                            <a class="dropdown-item"
                                                                                href="{{ route('football_club.payment.status', ['id' => $football_club->id, 'status' => 'not_paid']) }}">Not
                                                                                Paid</a>
    
                                                                        </div>
                                                                    </div>
    
                                                                    <p class="text-{{ $football_club->payment == 'paid' ? 'success' : 'danger' }} m-2">
                                                                        {{ $football_club->payment }}</p>
                                                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="card text-center">
                                    <div class="card-header">
                                        ...
                                        <a href="{{ route('football_club.export.pdf', $football_club->football_club->id) }}"
                                        ...
                                        <div class="mx-auto d-block">
                                            @if ($football_club->photo)
                                                <img class="rounded-circle mx-auto d-block"
                                                    src="{{ asset('images/' . $football_club->photo) }}" alt="Photo"
                                                    width="100px">
                                            @else
                                                No Photo
                                            @endif
                                            ...
                                            <h5 class="text-sm-center mt-2 mb-1">Phone:
                                                {{ $football_club->football_club->phone }}</h5>
                                            <p class="text-sm-center mt-2 mb-1">Address:
                                                {{ $football_club->football_club->address }}</p>
                                            <p class="text-sm-center mt-2 mb-1">Country:
                                                {{ $football_club->football_club->country }}</p>
                                            <p class="location text-sm-center">Contact:
                                                {{ $football_club->football_club->contact }}</p>
                                            <p class="location text-sm-center ">Payment Status:
                                            <p
                                                class="text-{{ $football_club->football_club->payment == 'paid' ? 'success' : 'danger' }}">
                                                {{ ucwords(str_replace('_', ' ', $football_club->football_club->payment)) }}
                                            </p>
                                            </p>
                                        </div>
                                        <hr>
