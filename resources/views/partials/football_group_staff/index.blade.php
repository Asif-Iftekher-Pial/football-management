                            ...
                            <table class="table table-borderless table-data3" id="myTable">
                                ...
                                <tr>
                                    ...
                                    <td >
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                              <a class="dropdown-item" href="{{ route('admin.approve.status',['id' => $staff->id, 'status' => 'approved']) }}">Approved</a>
                                              <a class="dropdown-item" href="{{ route('admin.approve.status', ['id' => $staff->id, 'status' => 'not_approved']) }}">Reject</a>
                                    ...
                                    <td class="row justify-content-between">
                                        {{-- edit button --}}
                                        @hasallroles($collectionOfRoles)
                                        <a href="{{ route('football-group-staff.edit', $staff->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                        @endhasallroles
                                        <a href="{{ route('footballGroup.export.pdf', $staff->id) }}" class="btn btn-success btn-sm"><i class="fa fa-print" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
