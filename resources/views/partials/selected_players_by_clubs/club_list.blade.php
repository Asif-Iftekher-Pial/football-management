        ...
        <div class="col-lg-12">
            <div class="au-card recent-report">
                <div class="au-card-inner">
                    ...
                    <h2 class="title-1">Player - {{ $all_clubs_of_player->name }}</h2>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive m-b-40">
                                <table class="table table-borderless table-data3" id="myTable">
                                    ...
                                    <tbody>
                                        @foreach ($all_clubs_of_player->clubs as $club_detail)
                                            <tr>
                                                <td>
                                                ...
                                                <td class="row justify-content-between">
                                                    {{-- edit button --}}
                                                    <a href="{{ route('remove.selected.club', ['player_id' => $all_clubs_of_player->id, 'club_id' => $club_detail->id]) }}"
